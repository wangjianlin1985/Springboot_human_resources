...
<div class="loginWraper" style="background: #3283AC url(../images/mgr.jpeg) no-repeat center;">
	<div id="loginform" class="loginBox">
		<h3 class="text-c c-white">主管登录</h3>
		<form action="/emp/manager/login-form" method="post" class="form form-horizontal" id="loginForm">
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont" style="color: #fff;">&#xe60d;</i></label>
				<div class="formControls col-xs-8">
					<input id="username" name="username" type="text" placeholder="员工号" class="input-text size-L">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-3"><i class="Hui-iconfont" style="color: #fff;">&#xe60e;</i></label>
