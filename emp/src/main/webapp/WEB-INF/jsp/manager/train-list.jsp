						...
						<c:forEach items="${page.records }" var="row" varStatus="vs">
							<tr>
								...
								<td>
									...
									<a href="/emp/manager/toupdatetrain?aid=${row.trainId }"><button class="btn btn-success size-S"><i class="Hui-iconfont" style="color: #fff;">&#xe645;</i>总结</button></a>
									</c:if>
									<a href="/emp/manager/traindetail?aid=${row.trainId }"><button class="btn btn-primary size-S"><i class="Hui-iconfont" style="color: #fff;">&#xe6e0;</i>&nbsp;详情</button></a>
									<a href="#" onclick="delcfm(${row.trainId});"><button class="btn btn-danger size-S"><i class="Hui-iconfont" style="color: #fff;">&#xe6e2;</i>&nbsp;删除</button></a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
