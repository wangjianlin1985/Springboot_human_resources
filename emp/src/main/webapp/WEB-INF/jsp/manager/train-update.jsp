...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<form action="updatetrain" method="post" class="form form-horizontal">
			<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">培训总结：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<textarea rows="3" cols="50" name="summary"></textarea>
				</div>
			</div>
			<div class="row cl">
